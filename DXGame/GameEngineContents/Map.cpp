...
{
	{
		...
		if (_Main2 != "")
		{
			MainBackGround2 = CreateComponent<GameEngineSpriteRenderer>(ContentsRenderType::BackGroundobject);
			//MainBackGround2->SetMaterial("2DTextureAlwaysDepth");
			MainBackGround2->SetSprite(_Main2);
			PixelBackGround2 = CreateComponent<GameEngineSpriteRenderer>(ContentsRenderType::BackGroundobject);
